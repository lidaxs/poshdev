<#
    ...
    wishlist
    if switch ShowHostNames is used put ipaddress in parentheses behind the hostaddress like "srv-rhap01 : 10.200.12.200"
#>
                ...
                if($Computer -ne $env:COMPUTERNAME){
                    ...
                    #gather results
                        if(test-path $remoteTempFile){
                            ...
                            Try {
                                $results = Get-Content $remoteTempFile | Select-String -Pattern '(TCP|UDP)'
                            }
                            Catch {
